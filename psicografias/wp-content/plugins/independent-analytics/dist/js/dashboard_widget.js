...
})({"kNoSz":[function(require,module,exports) {
...
},{"@hotwired/stimulus":"27q4D","./controllers/chart_controller":"hrjuy","@parcel/transformer-js/src/esmodule-helpers.js":"jIm8e"}],"27q4D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var extend = function _target() {
    var extendWithReflect = function extendWithReflect(constructor) {
        function extended() {
    ...
    var testReflectExtension = function testReflectExtension() {
        var a = function a() {
            this.a.call(this);
        };
...
},{}],"hrjuy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    (0, _createClassJsDefault.default)(_class, [
        {
            ...
            value: function connect() {
                ...
                if (!this.previewValue) data.datasets.push({
                    label: "Sessions",
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    if (typeof context.dataset.tooltipLabel !== "function") return context.dataset.label + ": " + context.raw;
                                    return context.dataset.tooltipLabel(context.dataset.label, context.raw);
                                }
                            }
                        }
                    },
                ...
                if (!this.previewValue && this.usingWoocommerceValue) {
                    data.datasets.push({
                        label: "Orders",
                ...
                if (!this.previewValue && this.usingWoocommerceValue) {
                    ...
                    data.datasets.push({
                        ...
                        tension: 0.4,
                        yAxisID: "y2",
                        tooltipLabel: function(label, rawValue) {
                            return label + ": " + _this.formatAsCurrency(rawValue);
                        },
                        hidden: true
                    });
                    options.scales.y2 = {
                        ...
                        ticks: {
                            ...
                            callback: function(value, index, ticks) {
                                return _this.formatAsCurrency(value);
                            }
                        }
                    };
                }
                ...
                var myChart = new (0, _chartJs.Chart)(element, config);
            }
        },
        {
            key: "formatAsCurrency",
            value: function formatAsCurrency(value) {
                return new Intl.NumberFormat(this.languageValue, {
                    style: "currency",
...
},{"@swc/helpers/lib/_class_call_check.js":"gNxF8","@swc/helpers/lib/_create_class.js":"iyoaN","@swc/helpers/lib/_define_property.js":"6IXzf","@swc/helpers/lib/_inherits.js":"atvDk","@swc/helpers/lib/_to_consumable_array.js":"cccKv","@swc/helpers/lib/_create_super.js":"5rW3S","@hotwired/stimulus":"27q4D","../chart_plugins/corsair_plugin":"8YKyT","../chart_plugins/html_legend_plugin":"dVdIk","chart.js":"h4klJ","@parcel/transformer-js/src/esmodule-helpers.js":"jIm8e"}],"8YKyT":[function(require,module,exports) {
module.exports = {
    id: "corsair",
...
},{}],"dVdIk":[function(require,module,exports) {
module.exports = {
    id: "htmlLegend",
    ...
    afterUpdate: function(chart, args, options) {
        ...
        items.forEach(function(legendData) {
            var legendID = legendData.text.toLowerCase().split(" ").join("-");
            ...
            li.classList.add("legend-item", "legend-item-for-".concat(legendID));
...
},{"@swc/helpers/lib/_class_call_check.js":"gNxF8","@swc/helpers/lib/_create_class.js":"iyoaN","@swc/helpers/lib/_define_property.js":"6IXzf","@swc/helpers/lib/_to_consumable_array.js":"cccKv","@swc/helpers/lib/_type_of.js":"9FF45","@parcel/transformer-js/src/esmodule-helpers.js":"jIm8e"}]},["kNoSz"], "kNoSz", "parcelRequirec571")
