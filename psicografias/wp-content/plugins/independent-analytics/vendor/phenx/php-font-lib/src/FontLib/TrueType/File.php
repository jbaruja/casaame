 ...
 */
namespace IAWP_SCOPED\FontLib\TrueType;

use IAWP_SCOPED\FontLib\AdobeFontMetrics;
use IAWP_SCOPED\FontLib\Font;
use IAWP_SCOPED\FontLib\BinaryStream;
use IAWP_SCOPED\FontLib\Table\Table;
use IAWP_SCOPED\FontLib\Table\DirectoryEntry;
use IAWP_SCOPED\FontLib\Table\Type\glyf;
use IAWP_SCOPED\FontLib\Table\Type\name;
use IAWP_SCOPED\FontLib\Table\Type\nameRecord;
/**
 * TrueType font file.
 *
...
class File extends BinaryStream
{
    ...
    protected function readTable($tag)
    {
        ...
        if (!self::$raw) {
            ...
            $class = "IAWP_SCOPED\\FontLib\\Table\\Table";
        }
        /** @var Table $table */
