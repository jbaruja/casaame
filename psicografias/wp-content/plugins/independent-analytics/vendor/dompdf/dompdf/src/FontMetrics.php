...
class FontMetrics
{
    ...
    private function loadFontFamiliesLegacy()
    {
        ...
        if (\is_readable($legacyCacheFile)) {
            ...
            if (!\defined("IAWP_SCOPED\\DOMPDF_DIR")) {
                \define("IAWP_SCOPED\\DOMPDF_DIR", $rootDir);
            }
            if (!\defined("IAWP_SCOPED\\DOMPDF_FONT_DIR")) {
                \define("IAWP_SCOPED\\DOMPDF_FONT_DIR", $fontDir);
            }
