 ...
 */
namespace IAWP_SCOPED\Dompdf;

use IAWP_SCOPED\Dompdf\Renderer\AbstractRenderer;
use IAWP_SCOPED\Dompdf\Renderer\Block;
use IAWP_SCOPED\Dompdf\Renderer\Image;
use IAWP_SCOPED\Dompdf\Renderer\ListBullet;
use IAWP_SCOPED\Dompdf\Renderer\TableCell;
use IAWP_SCOPED\Dompdf\Renderer\TableRowGroup;
use IAWP_SCOPED\Dompdf\Renderer\Text;
/**
 * Concrete renderer
 *
