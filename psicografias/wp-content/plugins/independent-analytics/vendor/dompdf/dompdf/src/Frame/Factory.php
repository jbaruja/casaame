 ...
 */
namespace IAWP_SCOPED\Dompdf\Frame;
...
use IAWP_SCOPED\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use IAWP_SCOPED\Dompdf\FrameReflower\Page as PageFrameReflower;
use IAWP_SCOPED\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
/**
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null) : ?AbstractFrameDecorator
    {
        ...
        $decorator = "IAWP_SCOPED\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "IAWP_SCOPED\\Dompdf\\FrameReflower\\{$reflower}";
    ...
    protected static function getPositionerInstance(string $type) : AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\IAWP_SCOPED\\Dompdf\\Positioner\\' . $type;
