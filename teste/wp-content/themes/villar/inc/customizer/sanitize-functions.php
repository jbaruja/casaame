 ...
 */
function villar_sanitize_select( $input, $setting ) {
 ...
 * @return string Sanitized slug if it is a valid choice; otherwise, the setting default.
 */
function villar_sanitize_multi_select( $input, $setting ) {
	// Get list of choices from the control associated with the setting.
	$choices    = $setting->manager->get_control( $setting->id )->choices;
	$input_keys = $input;
 ...
 */
function villar_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function villar_sanitize_post( $input ) {
 ...
 */
function villar_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since 1.0.0
 */
function villar_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function villar_sanitize_number_range( $number, $setting ) {
